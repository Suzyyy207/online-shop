...
| username | 用户名 |           |
| goodsId | 商品id |           |
| num | 添加的商品个数**（可正可负，正代表添加，负代表减少数量）** |           |
...
| 参数名 | 含义         | 类型&备注         |
| ------ | ------------ | ----------------- |
| data.shopAccount  | 商城账户余额 |  |

### 商城账户展示
| 接口名      | 方法 | 功能         |
| ----------- | ---- | ------------ |
| getProfitAccount | GET | 获取总利润 |

参数列表 back->front
| 参数名 | 含义         | 类型&备注         |
| ------ | ------------ | ----------------- |
| data.profitAccount  | 商城总利润 |  |

| 接口名      | 方法 | 功能         |
| ----------- | ---- | ------------ |
| getIntermediaryAccount | GET | 获取中间账户余额 |

参数列表 back->front
| 参数名 | 含义         | 类型&备注         |
| ------ | ------------ | ----------------- |
| data.intermediaryAccount  | 中间账户余额 |  |
